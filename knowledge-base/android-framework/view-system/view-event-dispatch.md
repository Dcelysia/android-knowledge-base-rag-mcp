...
> 本文是事件分发的深挖层，适合在忘记细节、排查滑动冲突或准备源码追问时查阅。只想快速复习时，可阅读 [Android 高级八股中的事件分发速览](/八股/Android高级/02-Handler-View-RecyclerView-Fragment-WebView#view-event-dispatch-overview)。
